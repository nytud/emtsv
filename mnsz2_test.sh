...
# -> 18sec
( echo "string" ; cat test_input/mnsz2_radio_1mio.tok.test ) | ./trivToken.sh | ./trivSentSplit.sh | python3 ./emMorphREST.py --pipe | python3 ./emTagREST.py --pipe | python3 ./depToolREST.py --pipe > out
